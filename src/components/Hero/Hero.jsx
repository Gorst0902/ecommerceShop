...
const HeroData = [
    {
        ...
        title: "Wireless",
        title2: "Headphone",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti, sequi laboriosam quo saepe distinctio ex maxime reiciendis necessitatibus eos. Maxime iste est consequatur? Numquam nostrum cupiditate, quod soluta alias maxime."
    },
    {
        id: 2,
        img: Image2,
                                ...
                                <div key={product.id}>
                                    <div className='grid grid-cols-1 sm:grid-cols-2'>
                                        ...
                                        >
                                            ...
                                            <h1 className='text-5xl sm:text-6x lg:text-2xl font-bold'>
                                                {product.title}
                                            </h1>
